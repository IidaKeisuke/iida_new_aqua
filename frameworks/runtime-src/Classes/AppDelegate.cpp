...
bool AppDelegate::applicationDidFinishLaunching()
{
    ...
    if(!glview) {
        ...
        glview = cocos2d::GLViewImpl::create("AppTemplate");
#else
        glview = cocos2d::GLViewImpl::createWithRect("AppTemplate", Rect(0,0,1136,640));
#endif
    ...
    sc->addRegisterCallback(js_register_native_binding);
